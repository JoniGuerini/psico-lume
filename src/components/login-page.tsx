...
export function LoginPage({ onLogin }: LoginPageProps) {
  ...
  return (
    <div className="grid min-h-svh lg:grid-cols-2">
      <div className="relative hidden flex-col items-center justify-center overflow-hidden bg-sidebar p-12 text-center text-sidebar-foreground lg:flex">
        <div
          aria-hidden="true"
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute -bottom-28 -left-20 size-80 rounded-full bg-sidebar-primary/10 blur-3xl"
        />
