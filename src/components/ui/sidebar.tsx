  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          "group/sidebar-wrapper relative isolate flex min-h-svh w-full overflow-hidden has-data-[variant=inset]:bg-sidebar",
          className
        )}
        {...props}
      >
        {showGlow ? <LumeNavyGlow fixed /> : null}
    ...
    >
      ...
      >
        <div
          ...
          className="relative flex size-full flex-col overflow-hidden bg-sidebar group-data-[variant=inset]:bg-transparent group-data-[variant=floating]:rounded-2xl group-data-[variant=floating]:bg-sidebar group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border"
        >
          <div className="relative z-10 flex min-h-0 flex-1 flex-col">
            {children}
          </div>
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn(
        "relative flex w-full min-w-0 flex-col p-2 group-data-[collapsible=icon]:items-center group-data-[collapsible=icon]:p-0",
        className
      )}
      {...props}
    />
  ...
  "peer/menu-button group/menu-button flex w-full items-center gap-2 overflow-hidden rounded-xl px-3 py-2 text-left text-sm ring-sidebar-ring outline-hidden transition-[width,height,padding] group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:p-2! group-data-[collapsible=icon]:[&>span:last-child]:hidden hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground data-[active=true]:bg-sidebar-primary data-[active=true]:font-medium data-[active=true]:text-sidebar-primary-foreground data-[active=true]:hover:bg-sidebar-primary data-[active=true]:hover:text-sidebar-primary-foreground [&_svg]:size-4 [&_svg]:shrink-0 [&>span:last-child]:truncate",
  {
    variants: {
      ...
      size: {
        default: "h-9 text-sm",
        sm: "h-8 text-xs",
        lg: "h-14 px-3 text-sm group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2!",
      },
    },
    defaultVariants: {
      variant: "default",
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent
        ...
        className="border border-border bg-card font-medium text-card-foreground shadow-md [&_svg]:bg-card [&_svg]:fill-card"
        {...tooltip}
      />
    </Tooltip>
  )
