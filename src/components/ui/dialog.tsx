...
import { DialogCloseLabel } from "@/components/ui/dialog-close-label"
      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close data-slot="dialog-close" asChild>
            <Button
              variant="ghost"
              className="absolute top-4 right-4 border bg-card text-foreground shadow-sm hover:bg-accent"
              size="icon-sm"
            >
              <XIcon
              />
