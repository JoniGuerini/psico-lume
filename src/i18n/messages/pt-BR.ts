export const ptBR = {
  ...
  finance: {
    ...
    charts: {
      ...
      revenueByApproach: "Receita por abordagem",
      revenueByApproachHint: "Quanto cada linha de trabalho representa por mês",
  ...
  patients: {
    ...
    records: {
      ...
      subtitle: "Histórico de evolução e notas de sessão de {{name}}.",
      newNote: "Nova evolução",
      stats: {
        notes: "Notas registradas",
        lastSession: "Última sessão",
        tags: "Tags distintas",
        approach: "Abordagem",
      },
      latestNote: "Última evolução",
      ...
      plan: "Plano / tarefa",
      editNote: "Editar evolução",
      deleteNote: "Excluir evolução",
  ...
  patientForm: {
    ...
    placeholders: {
      ...
      birthDate: "Selecionar data de nascimento",
      ...
      approach: "TCC, Psicanálise, Humanista…",
      therapyStart: "Selecionar início da terapia",
  ...
  sessionNote: {
    titleNew: "Nova evolução",
    titleEdit: "Editar evolução",
    descCreate:
      "Registre a nota da sessão de {{name}}. Resumo e evolução clínica são obrigatórios.",
    descEdit:
      "Atualize a nota da sessão de {{name}}. Resumo e evolução clínica são obrigatórios.",
    ...
    tags: "Tags",
    save: "Salvar evolução",
    create: "Registrar evolução",
    saveChanges: "Salvar alterações",
    ...
    sections: {
      identification: {
        ...
        description:
          "Metadados do encontro — preenchidos antes do registro clínico.",
      },
      clinical: {
    ...
    hints: {
      summary: "Temas abordados, queixas trazidas e contexto do encontro.",
      evolution:
