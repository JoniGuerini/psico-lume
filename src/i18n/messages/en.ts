...
export const en = {
  ...
  finance: {
    ...
    details: {
      ...
      title: "Finance data",
      description:
        "Review billable sessions and patient totals for {{month}} — the same source as this dashboard.",
      monthPlaceholder: "Month",
      monthCurrent: "Current month",
      monthPrevious: "Previous month",
      billableCount: "Billable sessions",
      tabs: {
        sessions: "By session",
        patients: "By patient",
        periods: "By period",
      ...
      overdueSessions: "{{count}} overdue",
      emptySessions: "No billable sessions this month.",
      emptyPatients: "No patients with billable sessions this month.",
      emptyPeriods: "No days with billable sessions this month.",
    },
    range: {
  ...
  patients: {
    ...
    records: {
      ...
      subtitle: "Progress notes and clinical documentation for {{name}}.",
      newNote: "New record",
      stats: {
        notes: "Records",
        lastSession: "Last linked session",
        tags: "Distinct tags",
      },
      latestNote: "Latest record",
      sessionBadge: "Session {{number}} · {{date}}",
      standaloneBadge: "Standalone · {{date}}",
      planPrefix: "Plan:",
      historyTitle: "Record history",
      sessionNumber: "Session {{number}}",
      standaloneTitle: "Standalone record",
      badgeLinked: "Session",
      ...
      emptyDescription:
        "Add a progress note linked to a session, or a standalone record.",
      delete: {
        title: "Delete record?",
        description:
          "The note for session {{number}} ({{date}}) will be permanently removed from {{name}}'s records.",
        descriptionLinked:
          "The progress note for session {{number}} ({{date}}) will be permanently removed from {{name}}'s records.",
        descriptionStandalone:
          "The standalone record from {{date}} will be permanently removed from {{name}}'s records.",
  ...
  sessionNote: {
    ...
    descCreate:
      "Record a progress note for {{name}}. Summary and clinical progress are required.",
    descEdit:
      "Update the record for {{name}}. Summary and clinical progress are required.",
    linkMode: {
      label: "Record type",
      linked: "Link to session",
      linkedHint: "Uses calendar date and time",
      standalone: "Standalone record",
      standaloneHint: "Not tied to the calendar",
    },
    selectSession: "Calendar session",
    searchSession: "Search session...",
    noLinkableSessions:
      "No sessions available to link. Schedule a session or use a standalone record.",
    ...
    errors: {
      selectSession: "Select a calendar session to link.",
      sessionAlreadyLinked:
        "This session already has a progress note in the chart.",
    },
    sections: {
      identification: {
        title: "Identification",
        description:
          "Choose whether this record links to a session or stands alone.",
      },
      clinical: {
        title: "Clinical record",
        description: "Main chart content for this entry.",
      },
    },
    placeholders: {
    ...
    hints: {
      summary: "Topics covered, concerns raised, and context.",
