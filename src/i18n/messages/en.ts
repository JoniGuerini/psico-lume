...
export const en = {
  ...
  finance: {
    ...
    charts: {
      ...
      revenueByApproach: "Revenue by approach",
      revenueByApproachHint: "How each therapeutic line contributes per month",
  ...
  patientForm: {
    ...
    placeholders: {
      ...
      approach: "CBT, Psychoanalysis, Humanistic…",
      therapyStart: "Select therapy start date",
